  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column",paddingLeft: "0.1mm", paddingRight: "0.1mm"}}>
        {/* PRODUCT */}
        <div style={{ display: "flex", height: dims.rowHeight, borderBottom: "2px solid #FFF" }}>
          <div style={{ 
            width: dims.keyWidth, 
            backgroundColor: "#000", 
            color: "white", 
...
function PrintPreview() {
  ...
  const handlePrint = async () => {
    ...
    // Build logo HTML
    const logoHtml = companyLogo 
      ? `<img src="${companyLogo}" alt="Logo" style="height: ${logoHeight}; width: 70%; " />` //object-fit: contain;
      : `<span style="color: #2563eb; font-weight: bold; font-size: ${isRoll ? '5mm' : '4mm'};">jr</span><span style="color: #374151; font-weight: 600; font-size: ${isRoll ? '5mm' : '4mm'};">tech</span><span style="color: #22c55e; font-weight: 600; font-size: ${isRoll ? '5mm' : '4mm'};">labs</span><span style="color: #9ca3af; font-size: ${isRoll ? '2.5mm' : '2mm'}; margin-left: 1mm;">pvt . ltd</span>`;
