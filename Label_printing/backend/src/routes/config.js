...
// // // PRINT_FORMAT ROUTES
// // // ============================================
// // router.get('/formats/all', configController.getFormats);  // Specific first
// // router.get('/formats/:id', configController.getFormatById); // Then specific
...
// // // LABEL_CONFIG ROUTES 
// // // ============================================
// // router.get('/', configController.getConfigs);             // General last
// // router.post('/', configController.createConfig);
// // router.get('/:id', configController.getConfigById);       // Wildcard last
