...
// export async function createConfig(companyName, logoUrl, madeInValue) {
//   const result = await query(
//     'INSERT INTO Label_Config (company_name, logo_url, made_in_value, is_active) VALUES ($1, $2, $3, true) RETURNING *',
//     [companyName, logoUrl, madeInValue]
//   );
//   return result.rows[0];
// }

// export async function updateConfig(configId, companyName, logoUrl, madeInValue, isActive) {
//   const result = await query(
//     'UPDATE Label_Config SET company_name = $1, logo_url = $2, made_in_value = $3, is_active = $4, updated_at = CURRENT_TIMESTAMP WHERE config_id = $5 RETURNING *',
//     [companyName, logoUrl, madeInValue, isActive, configId]
//   );
//   return result.rows[0];
// }
